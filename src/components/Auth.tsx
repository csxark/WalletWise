...
import { Eye, EyeOff, Mail, Lock, User, Wallet, Sparkles, Shield, AlertCircle } from 'lucide-react';
...
const Auth = () => {
  ...
  useEffect(() => {
    setError('');
    setSuccess('');
  }, [email, password, confirmPassword, isSignUp, isResetMode]);
        ...
        <div className={`backdrop-blur-xl rounded-3xl shadow-2xl border p-8 ${
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className={`h-16 w-16 rounded-3xl flex items-center justify-center shadow-xl ${
                isDark
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 focus:border-transparent font-medium ${
                    isDark
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-3 border rounded-xl focus:ring-2 focus:border-transparent font-medium ${
                      isDark
                        ? 'border-slate-600 bg-slate-700 text-white focus:ring-yellow-500'
                        : 'border-gray-300 bg-white text-gray-900 focus:ring-blue-500'
                    }`}
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full text-white py-4 px-6 rounded-xl transition-all duration-200 font-bold text-lg flex items-center justify-center space-x-3 shadow-lg hover:scale-105 disabled:hover:scale-100 disabled:cursor-not-allowed ${
                isDark
